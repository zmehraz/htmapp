...
#include "cpp/file_index.h"
	...
	long add_items( str::t_string sRoot, t_pb &pb, CFileIndex &fi, CFileIndex::t_block b, long lMaxTop, long lMaxDepth, long lDepth = 0 )
	{
		...
		{	pb[ "name" ] = "used";
			...
			pb[ "size" ] = p->size;
			pb[ "path" ] = sRoot;
			pb[ "szstr" ] = str::SizeStr< str::t_char, str::t_string >( (double)p->size, 1024., 3 ) + "B";
...
//			pb[ "hi_colour" ] = "#a0ff00";
	...
	long index_callback( CFileIndex *pFi, void *p )
	{
		...
		pbFree[ "size" ] = job[ "drive" ][ "bytes_free" ].ToInt64();
		pbFree[ "path" ] = "[ Free Space ]";
		pbFree[ "szstr" ] = str::SizeStr< str::t_char, str::t_string >( (double)job[ "drive" ][ "bytes_free" ].ToInt64(), 1024., 3 ) + "B";
